...
*/
#define SLANG_H_INSIDE_SLANG_DIR 
...
#define unix     /* slang requires it */
#define OS2EMX
#define OS2EMX_CHG
#define ALTERNATIVE_CONSOLE 1 
#define LOCAL_DRIVES 1
#define HETER_NET 1
#define OS_INFO "OS/2" 
...
char *tmpnam_ext(char *ext);

#define rename(a,b) my_rename(a,b)

#if defined  __os2__ || defined OS2_NT 
#error Not used in OS2EMX
#endif
